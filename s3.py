...
model2.save("2nn.x")
chekcb = keras.callbacks.ModelCheckpoint('best2rnn.model.x', save_best_only=True)
earlycb = keras.callbacks.EarlyStopping(patience=3, restore_best_weights=True)
...
chekcb = keras.callbacks.ModelCheckpoint('bestgrumodel.model.x', save_best_only=True)
earlycb = keras.callbacks.EarlyStopping(patience=3, restore_best_weights=True)
...
model4 = keras.models.load_model('2nn.x')
